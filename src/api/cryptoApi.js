...
export const getCryptoIdFromInput = (input) => {
    const normalizedInput = input.toLowerCase();
    // Buscar en la lista
    const crypto = cryptoList.find((c) => c.id.toLowerCase() === normalizedInput ||
...
export const fetchCryptoDetails = async (cryptoName) => {
    if (!cryptoName) {
